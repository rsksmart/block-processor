...
public interface Trie {
    ...
    // Special value Integer.MAX_VALUE means collect them all.
        ...
        /*
        public Iterator<co.rsk.tools.processor.TrieTests.sepAttempt.ExpandedTrie.IterationElement> getInOrderIterator() {
            return new co.rsk.tools.processor.TrieTests.sepAttempt.ExpandedTrie.InOrderIterator(this);
        }

        public Iterator<co.rsk.tools.processor.TrieTests.sepAttempt.ExpandedTrie.IterationElement> getPreOrderIterator() {
            return new co.rsk.tools.processor.TrieTests.sepAttempt.ExpandedTrie.PreOrderIterator(this);
        }


        public Iterator<co.rsk.tools.processor.TrieTests.sepAttempt.ExpandedTrie.IterationElement> getPostOrderIterator() {
            return new co.rsk.tools.processor.TrieTests.sepAttempt.ExpandedTrie.PostOrderIterator(this);
        }
        */
