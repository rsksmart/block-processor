...
public class AccountState {
    ...
    public static final byte[] EMPTY_DATA_HASH = Keccak256Helper.keccak256(EMPTY_BYTE_ARRAY);
    ...
    public AccountState(byte[] rlpData) {
        ...
        this.nonce = bytesToBigInteger(items.get(0).getRLPData());
        this.balance = bytesToBigInteger(items.get(1).getRLPData());
